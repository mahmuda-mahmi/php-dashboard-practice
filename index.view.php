        ...
        <nav class="bg-gray-800">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden md:block">
                    ...
                    <a href="/" aria-current="page" class="rounded-md bg-gray-900 px-3 py-2 text-lg font-medium text-white">Home</a>
                    <a href="/about" aria-current="page" class="rounded-md bg-gray-900 px-3 py-2 text-lg font-medium text-white">about</a>
                    <a href="/contact" aria-current="page" class="rounded-md bg-gray-900 px-3 py-2 text-lg font-medium text-white">contact</a>
